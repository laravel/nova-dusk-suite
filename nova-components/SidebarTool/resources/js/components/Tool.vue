<template>
    <div>
        ...
        <card class="flex flex-col items-center justify-center" style="min-height: 300px">
            ...
            <p class="dark:text-white text-lg">You can edit this tool's component at: <code class="ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">/nova-tools/Sidebar Tool/resources/js/components/Tool.vue</code></p>
        </card>
    </div>
</template>
